package com.github.jinahya.epost.openapi.proxy._hidden._reactor.util.context;
...
public final class _Context_Utils {
    ...
    public static Mono<UriComponentsBuilder> getUriComponentsBuilderFromRequestBaseUrl() {
        return getRequestBaseUrl().map(UriComponentsBuilder::fromUriString);
    }
